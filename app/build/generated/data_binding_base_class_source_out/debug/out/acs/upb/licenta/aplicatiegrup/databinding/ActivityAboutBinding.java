...
public final class ActivityAboutBinding implements ViewBinding {
  ...
  private ActivityAboutBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textAbout) {
  ...
  public static ActivityAboutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAboutBinding((ConstraintLayout) rootView, textAbout);
    }
